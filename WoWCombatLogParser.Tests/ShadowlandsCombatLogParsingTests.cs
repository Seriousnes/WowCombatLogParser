...
namespace WoWCombatLogParser.Tests
{
    public class ShadowlandsCombatLogParsingTests : CombatLogParsingTestBase
    {
        ...
        public ShadowlandsCombatLogParsingTests(ITestOutputHelper output) : base(output)
        {
            //eventGenerator = new EventGenerator
            //{
            //    CombatLogVersion = new CombatLogVersion
            //    {
            //        AdvancedLogEnabled = true,
            //        Version = CombatLogVersionEnum.Shadowlands
            //    }
            //};
        }
        ...
        {
            var parser = new CombatLogParser(@"TestLogs/Shadowlands/WoWCombatLog-112821_193218.txt");
        ...
        {
            var @event = GetCombatLogEvent<SpellDispel>(input);
            @event.Parse();
            // unit name testing
        ...
        {
            var @event = GetCombatLogEvent<EncounterEnd>(input);
            @event.Parse();
        ...
        {
            var combatantInfo = GetCombatLogEvent<ShadowlandsCombatantInfo>(input);
        ...
        {
            var @event = GetCombatLogEvent<DamageSplit>(input);
            @event.Parse();
        }
        ...
        {
            var @event = GetCombatLogEvent<CombatLogEvent>(input);
            @event.Parse();
